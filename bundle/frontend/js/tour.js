...
const STEPS = [
    {
        ...
        body: 'Start here. Drag <strong>.xlsx</strong> files exported from <strong>Ca²⁺tch-One</strong> into this panel, or click <strong>Add Files</strong> in the header.<br><br>Type a <strong>condition name</strong> next to each file to group replicates (e.g. "Control", "Treated").',
        position: 'right',
    },
    {
        target: '#plot-tabs',
